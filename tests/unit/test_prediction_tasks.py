...
from backend.app.models import Prediction, PredictionStatus
from backend.app.worker import DatabaseTask, execute_prediction
...
@patch("backend.app.worker.charge_prediction")
