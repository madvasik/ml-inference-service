...
loyalty_tier_enum = postgresql.ENUM("NONE", "BRONZE", "SILVER", "GOLD", name="loyaltytier")
loyalty_tier_enum_ref = postgresql.ENUM(
    "NONE",
    "BRONZE",
    "SILVER",
    "GOLD",
...
payment_status_enum = postgresql.ENUM("PENDING", "CONFIRMED", "FAILED", name="paymentstatus")
...
def upgrade() -> None:
    ...
    op.add_column("users", sa.Column("loyalty_tier", loyalty_tier_enum_ref, nullable=False, server_default="NONE"))
    ...
    op.create_table(
        "loyalty_tier_rules",
        sa.Column("id", sa.Integer(), nullable=False),
        sa.Column("tier", loyalty_tier_enum_ref, nullable=False),
    ...
    op.bulk_insert(
        sa.table(
            "loyalty_tier_rules",
            sa.column("tier", loyalty_tier_enum_ref),
